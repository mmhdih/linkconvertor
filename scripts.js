...
function changeValue() {
    ...
    var newValue = innerValue.replace("5.75.130.20", "45.139.11.167").replace("116.202.3.144", "45.139.11.167").replace("88.198.122.138", "45.139.11.167").replace("95.217.245.72", "45.139.11.167");
